...
public class Condicionais {
    ...
    public static void main(String[] args) {
        ...
        if (numero > 125) {
            ...
            //Se a função retorna um boleano, eu posso usar no if
            ...
            //declaração do if ( comparação do retorno de booleano) {o queserá executado...}
        ...
        //Todo else precisa de um if, mas nem todo if precisa te um else
            ...
            //1 - Vou escolher qual situação que eu quero que mais ocorra
            //2 - melhorar a lógica
