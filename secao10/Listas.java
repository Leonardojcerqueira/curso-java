...
// Não criar um arquivo com o nome de Array
...
public class Listas {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Acessando o primeiro el: "+ numeros[0]);

        //Tamanho fixo, só que vazio
        String [] frutas = new String[3];

        //0, 1 e 2 => aa elementos
        // 3 => não tenho
       ...
       //lenght => A qtd de elementos de um array
       ...
       for( int i = 0; i < numeros.length; i++){
        ...
        for (int numero : numeros){
         ...
         //Concatnar elemntos de um array
        ...
        // verificar se o valor está presente em array
     ...
     System.out.println("Somar pares: " + somaPares);
  ...
  System.out.println(frutas[0]);
   ...
   for(int numero : numeros){
    ...
    //7 - adcionando notvos itnes a araays

    //ex1: Cirando um novvo array maior e copiando os els.
    ...
    //ex2: Utilizando o arraycopy para copiar os els.
