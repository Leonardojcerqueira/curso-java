...
public class Loops {
    ...
    public static void main(String[] args) {
        ...
        //Condição -> determina até quando o u quantas vezes, o loop vai rodar
    ...
    do {
        numero = (int) (Math.random() * 10);
            ...
            System.out.println("Valor aleatorio: " + numero);
    ...
    //break pode seer utilizado com qualquer estrutura de loop
